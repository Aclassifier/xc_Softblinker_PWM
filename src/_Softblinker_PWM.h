 ...
 */
    ...
    // ------------------------------------
        ...
        #define PARAMS_DEFAULTS { \
               {DEFAULT_SOFTBLINK_PERIOD_MS, DEFAULT_INTENSITY_STEPS, DEFAULT_DARK_INTENSITY, DEFAULT_FULL_INTENSITY, dark_LED, DEFAULT_PWM_FREQUENCY_HZ}}
    #elif (CONFIG_NUM_SOFTBLIKER_LEDS==2)
        #define PARAMS_DEFAULTS { \
               {DEFAULT_SOFTBLINK_PERIOD_MS, DEFAULT_INTENSITY_STEPS, DEFAULT_FULL_INTENSITY * 0.2, DEFAULT_FULL_INTENSITY * 0.8, dark_LED, DEFAULT_PWM_FREQUENCY_HZ}, \
               {DEFAULT_SOFTBLINK_PERIOD_MS, DEFAULT_INTENSITY_STEPS, DEFAULT_DARK_INTENSITY,       DEFAULT_FULL_INTENSITY,       dark_LED, DEFAULT_PWM_FREQUENCY_HZ}}
    #endif
    // {DEFAULT_SOFTBLINK_PERIOD_MS, DEFAULT_INTENSITY_STEPS, DEFAULT_FULL_INTENSITY * 0.2, DEFAULT_FULL_INTENSITY * 0.8, dark_LED, DEFAULT_PWM_FREQUENCY_HZ}, \
    //
